...
async function run() {
    try {
        ...
        // const instructorsCollection = client.db('Rainbow').collection('allInstructors')
        // const classCollection = client.db('Rainbow').collection('allClasses')
        // const selectedCollection = client.db('Rainbow').collection('selectedClasses')
...
// const uri = "mongodb+srv://<username>:<password>@cluster0.hrxywfz.mongodb.net/?retryWrites=true&w=majority";
